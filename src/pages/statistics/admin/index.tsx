...
export default function UsersSistemList({ user }: { user: User }) {
          ...
          .map((e: any) => {
            centrosMuyAux.push({
              ...
              label: `${e.ubicacion} - ${e.direccion} - ${e.nombre_centro} ${
                e.tiene_voluntario ? "- Voluntario activo" : ""
              } ${e.borrado ? "- (BORRADO)" : ""}`,
            });
          });
      });
  ...
  const mapDonacionesPorCategoria = () => {
    ...
    arr.sort(
      (a: any, b: any) =>
        b["Cantidad de donaciones"] - a["Cantidad de donaciones"]
    );
    return arr;
  };
  ...
  const trades = [
    {
      name: "Confirmados",
      trades:
        (statistics?.estadisticasGlobales
          .intercambiosConfirmadosConDonacionCount ?? 0) +
        (statistics?.estadisticasGlobales
          ?.intercambiosConfirmadosSinDonacionCount ?? 0),
    },
    {
      name: "Rechazados",
  ...
  const mapTopLocationTrades = () => {
    ...
    statistics?.estadisticasLocalidades.map((e) => {
      arr.push({
        ...
        Confirmados:
          e.intercambiosConfirmadosConDonacionLocalidadCount +
          e.intercambiosConfirmadosSinDonacionLocalidadCount,
    ...
    arr.sort(
      (a: any, b: any) =>
        ...
        b.Rechazados +
        b.Cancelados -
        (a.Confirmados + a.Rechazados + a.Cancelados)
    );
    let arrAux=[arr[0],arr[1],arr[2]]
    return arrAux;
  };
  ...
  const getInformationCenter = () => {
    return centersRawList
      ?.filter((x) => x.id_centro == centerSelected)
      .map((e) => {
        return (
  ...
  return (
    <RootLayout user={user}>
      <div className="">
        ...
        {statistics?.estadisticasGlobales == null ? (
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="w-[85vw] flex justify-between bg-blue-900 bg-opacity-10 p-[25px] rounded-[10px] items-center mt-[20px]">
              <form
            ...
            {statistics?.estadisticasVoluntario == null ? (
              <div>
                <p className="text-xl font-semibold text-blue-900  mt-[20px] m-auto">
                  ...
                  {dayFromAUX != "" && dayToAUX != ""
                    ? `- ${formatDate(dayFromAUX)} ➜ ${formatDate(dayToAUX)}`
                    : ""}
                </p>
                <div className="w-[100%] h-[1px] bg-blue-900 "></div>
                <div className="w-[85vw]">
                  <div className="w-[100%] flex justify-between my-[40px]">
                    <div className="w-[600px] bg-blue-900 bg-opacity-10 rounded-[10px] p-[20px] flex flex-col items-center">
                    ...
                    <div className="w-[650px] h-auto bg-blue-900 bg-opacity-10 rounded-[10px] flex flex-col items-center">
                      <h1 className="font-semibold text-black text-3xl pt-[20px]">
                        {dayFromAUX == "" && dayToAUX == ""
                          ? "Todos los intercambios"
                          : `Intercambios desde ${formatDate(
                              dayFromAUX
                            )} hasta ${formatDate(dayToAUX)}`}
                      </h1>
                      <LineChart
                  ...
                  <div className="w-[100%] flex justify-between my-[40px]">
                    <div className="flex flex-col items-center bg-blue-900 bg-opacity-10 p-[20px] rounded-[10px] w-[550px]">
                      <h1 className="font-semibold text-black text-3xl pb-[20px]">
                ...
                <div className="">
                  <div className="flex justify-between my-[40px]">
                    <div className="bg-blue-900 bg-opacity-10 rounded-[10px] w-[720px] flex justify-between">
                      <div className="w-[100%] p-[25px] text-black  flex flex-col items-center">
                        ...
                        <div className="w-[90%]">
                            ...
                            <div className="flex items-center ms-[20px]">
                              ...
                              <p className="ms-[5px]">
                                ...
                                <span className="font-semibold text-gray-700">
                                  ...
                                  {
                                    statistics.estadisticasGlobales
                                      .cantidadIntercambiosConfirmadosVoluntario
                                  }{" "}
                                  |
                                </span>
                              </p>
                          ...
                          <p className="text-lg flex justify-between">
                            ...
                            {
                              statistics?.estadisticasGlobales
                                .intercambiosConfirmadosConDonacionCount
                            }
                          </p>
                          <p className="text-lg flex justify-between">
                            <span className="font-semibold text-lg">
                          ...
                          <p className="text-lg flex justify-between">
                            ...
                            {
                              statistics?.estadisticasGlobales
                                .motivoDeCancelacionMasFrecuente
                            }
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="flex flex-col bg-blue-900 bg-opacity-10 rounded-[10px] w-[550px] p-[25px] items-center">
                      <h1 className="font-semibold text-black text-3xl pb-[20px]">
              ...
              <div className="w-[85vw]">
                {statistics?.estadisticasVoluntario ? (
                  statistics?.estadisticasVoluntario
                    .cantidadIntercambiosConfirmados != 0 ||
                  statistics?.estadisticasVoluntario
                    .cantidadIntercambiosCancelados != 0 ||
                  statistics?.estadisticasVoluntario
                    .cantidadIntercambiosRechazados != 0 ? (
                    <div className=" flex flex-col items-center w-[100%] ">
                      <div className="w-[100%]">
                        <p className="text-xl font-semibold text-blue-900 mt-[20px] m-auto">
                          ESTADISTICAS EN:{" "}
                          {statistics?.estadisticasVoluntario.nombre.toUpperCase()}
                        </p>
                      </div>
                      <div className="w-[100%] h-[1px] bg-blue-900 "></div>
                      <div className="h-[auto] w-[100%] mb-[40px]">
                        <div className="flex mt-[40px] justify-between">
                          <div className="w-[700px] h-auto bg-blue-900 bg-opacity-10 rounded-[10px] flex flex-col items-center">
                            <h1 className="font-semibold text-black text-3xl pt-[20px]">
                              {dayFromAUX == "" && dayToAUX == ""
                                ? "Todos los intercambios"
                                : `Intercambios desde ${formatDate(
                          ...
                          <div className="flex flex-col items-center bg-blue-900 bg-opacity-10 rounded-[10px] p-[25px]">
                            <h1 className="font-semibold text-black text-3xl">
                              Intercambios en{" "}
                              {statistics?.estadisticasVoluntario.nombre}
                            </h1>
                            <div className="flex justify-center items-center mt-[20px]">
                              <div>
                                <DonutChart
                          ...
                          <div className="w-[700px] bg-blue-900 bg-opacity-10 rounded-[10px] mt-[40px] ">
                            <div className="w-[100%] h-[100%] p-[25px] text-black ">
                              <p className="text-lg flex justify-between">
                                ...
                                <div className="flex items-center ms-[20px]">
                                  ...
                                  <p className="ms-[5px]">
                                    {
                                      statistics?.estadisticasVoluntario
                                        .nombreVoluntarioMasAuditador
                                    }{" "}
                                    {
                                      statistics?.estadisticasVoluntario
                                        .apellidoVoluntarioMasAuditador
                                    }{" "}
                                    <span className="font-semibold text-gray-700">
                                      |{" "}
                                      {
                                        statistics?.estadisticasVoluntario
                                          .cantidadVoluntarioMasAuditador
                                      }{" "}
                                      |
                                    </span>
                                  </p>
                              ...
                              <p className="text-lg flex justify-between">
                                ...
                                {
                                  statistics?.estadisticasVoluntario
                                    .motivoMasComunCancelacion
                                }
                              </p>
                            </div>
                          </div>
                          <div className="flex flex-col bg-blue-900 bg-opacity-10 rounded-[10px] w-[550px] p-[25px] mt-[40px]">
                    ...
                    <div className="flex justify-center">
                      <p className="text-2xl font-bold text-gray-500 m-auto mt-[40px]">
