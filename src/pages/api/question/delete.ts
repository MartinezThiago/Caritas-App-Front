...
export default async function handler(
    ...
    await axios
        .post(`${BACK_BASE_URL}CaritasBack/eliminarPregunta`, body, config)
        .then((result: any) => {
        ...
        .catch((result: any) => {
            try {
                ...
                res.status(500).json({ message: 'Ah ocurrido un error inesperado al momento de eliminar una pregunta.' })
            }
        },
        )
}