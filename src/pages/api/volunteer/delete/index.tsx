...
export default async function handler(
    ...
    const formData=req.body.idVolunteer
    console.log('BORRAR VOLUNTARIO', req.body.idVolunteer);

    await axios
        .get(`${BACK_BASE_URL}CaritasBack/borrarVoluntario?idUser=${formData}`, config)
        .then((result: any) => {
