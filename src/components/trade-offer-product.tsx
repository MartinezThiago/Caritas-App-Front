...
export default function TradeOfferProduct(props: TradeCardProductProps) {
  ...
  return (
    <Link href={`${props.idPost}`} className='w-[35%] h-[12rem] border-[3px] rounded-xl border-blue-900 hover:scale-105 duration-300'>
        ...
        <div className=''>
          <div className='flex content-between justify-between w-full'>
            ...
            <div className='m-3.5 w-6/12'>
              ...
              <p className={'text-black mt-[5px] text-sm'}><span className='text-rose-700 font-bold text-base'>{props.centersChoosedInfoTrade[0].nombre_centro}: </span>57 n1240</p>
              <p className={'text-black mt-[5px] text-sm'}><span className='text-rose-700 font-bold text-base'>{props.centersChoosedInfoTrade[0].nombre_centro}: </span>50 y 120 n200</p>
            </div>
          </div>
